/**
 * Type definitions for RodEruda
 * @see https://github.com/oirodolfo/eruda-console-browser
 */
declare module 'roderuda' {
  ...
  /**
   * Eruda Plugin
   * @see https://github.com/oirodolfo/eruda-console-browser/docs/plugin.html
   */
  ...
  /**
   * Eruda Util
   * @see https://github.com/oirodolfo/eruda-console-browser/docs/plugin.html#utility
   */
  export interface Util {
    evalCss(css: string): HTMLStyleElement
    isRodErudaEl(val: any): boolean
  ...
  /**
   * Eruda APIs
   * @see https://github.com/oirodolfo/eruda-console-browser/docs/api.html
   */
